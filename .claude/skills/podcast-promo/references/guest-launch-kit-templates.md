...
> Reference caricato on-demand dal Passaggio 8 di `podcast-promo` v4.3 (**SOLO se format = intervista**).
...
2. [8.1 Clip verticale specs (45-60s)](#81-clip-verticale-specs-45-60s)
3. [8.2 Post LinkedIn draft del guest (prima persona)](#82-post-linkedin-draft-del-guest-prima-persona)
4. [8.3 Post X draft del guest](#83-post-x-draft-del-guest)
5. [8.4 Quote-image spec](#84-quote-image-spec)
6. [8.5 Email accompagnatoria al guest (T-7gg)](#85-email-accompagnatoria-al-guest-t-7gg)
7. [Formato output complessivo (cap. 8 del promo file)](#formato-output-complessivo)
...
**Nota v4.0**: il Guest Launch Kit diventa un **capitolo** del promo file consolidato (cap. 8 del file finale), non un file separato. L'utente copia il blocco e lo incolla in email / Notion / DM al guest.

---

## 8.1 Clip verticale specs (45-60s)
...
## 8.2 Post LinkedIn draft del guest (prima persona)
...
**Nota**: alcuni guest non usano X attivamente. Chiedi nell'email (cap. 8.5) se preferiscono A o B, oppure forniscili entrambi e lasciali scegliere.

---

## 8.4 Quote-image spec
...
## 8.5 Email accompagnatoria al guest (T-7gg)
...
```
Ecco il Guest Launch Kit per [Nome Guest] (sara' cap. 8 del file promo
consolidato):
...
### 8.2 Post LinkedIn del guest (150-200 parole, prima persona, pronto da firmare)
[testo del post]

Commento 1 (il guest o tu lo metti):
https://www.youtube.com/watch?v={YT_ID}?utm_source=guest&utm_medium=linkedin&utm_campaign={campaign_id}

### 8.3 Post X del guest (280 char, prima persona)
[testo post singolo]
...
### 8.5 Email al guest (template copia-incolla, spedisci T-7gg)
...
**Gate**: il Passaggio 8 procede SOLO dopo "Va bene. Continua.".
